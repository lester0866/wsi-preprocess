...
FONT_PATH = "/home/lester/OpenSans-ExtraBold.ttf"
SUMMARY_TITLE_FONT_PATH = "/home/lester/OpenSans-Italic.ttf"
SUMMARY_TITLE_TEXT_COLOR = (0, 0, 0)
SUMMARY_TITLE_TEXT_SIZE = 12
...
class TileSummary:
  ...
  def top_tiles(self):
    ...
    top_tiles = [x for x in sorted_tiles if x.score != 0]
    return top_tiles
