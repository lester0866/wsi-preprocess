...
with open('/media/data_cifs/lester/pathology/ohad_train_list.pkl', 'rb') as f:
    SLIDE_LIST = pickle.load(f)
# SLIDE_LIST = glob.glob('/media/data_cifs/lester/ohad_5_16_19/**/*.svs')
# SLIDE_LIST[423] = SLIDE_LIST[1129]
# SLIDE_LIST[1375] = SLIDE_LIST[1129]
BASE_DIR = "/media/data_cifs/lester/ohad_tiles/"
# BASE_DIR = os.path.join(os.sep, "Volumes", "BigData", "TUPAC")
TRAIN_PREFIX = "OHAD-TR-"
...
T_SIZE = '224'
TILE_SUMMARY_DIR = os.path.join(BASE_DIR, "tile_" + T_SIZE +  "_summary_" + DEST_TRAIN_EXT)
...
TILE_DATA_DIR = os.path.join(BASE_DIR, "tile_data_" + T_SIZE )
...
TILE_DIR = os.path.join(BASE_DIR, "tiles_" + T_SIZE + "_" + DEST_TRAIN_EXT)
TILE_SUFFIX = "tile"
...
def get_training_slide_path(slide_number):
  ...
  slide_filepath = SLIDE_LIST[slide_number-1]
...
def get_num_training_slides():
  ...
  """
  num_training_slides = len(SLIDE_LIST)
